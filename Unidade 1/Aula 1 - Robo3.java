    ...
    float posicaoY = 50;
        ...
        public void move(float x, float y){
            ...
            public void printStatus(){
                ...
                System.out.println("Velocidade Max: " + velocidadeMax + " m/s");
                System.out.println("Carga Max do Robô: " + pesoCargaMax + "kg");
                System.out.println("Tipo Tração do Robô: " + tipoTracao);
                System.out.println("Posição X do Robô: " + posicaoX + "m");
                System.out.println("Posição Y do Robô: " + posicaoY + "m");
                System.out.println("-------------------------------");
            }
